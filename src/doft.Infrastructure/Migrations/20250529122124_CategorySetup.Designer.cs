...
namespace doft.Infrastructure.Migrations
{
    ...
    [Migration("20250529122124_CategorySetup")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("doft.Domain.Entities.TagLink", b =>
                {
                    b.HasOne("doft.Domain.Entities.DoftTask", null)
                        .WithMany("TagLinks")
                        .HasForeignKey("DoftTaskId");

                    b.HasOne("doft.Domain.Entities.Event", null)
                        .WithMany("TagLinks")
                        .HasForeignKey("EventId");

                    b.HasOne("doft.Domain.Entities.Note", null)
                        .WithMany("TagLinks")
                        .HasForeignKey("NoteId");
